...
export const calculateBackgroundSize = (backgroundImage, image, bounds) => {
    let width = 0;
    let height = 0;
...
export const calculateBackgroundPosition = (position, size, bounds) => {
...
export const calculateBackgroundRepeatPath = (background, position, size, backgroundPositioningArea, bounds) => {
...
export const parseBackground = (style, imageLoader) => {
    return {
...
export const parseBackgroundImage = image => {
    const whitespace = /^\s$/;
    const results = [];
