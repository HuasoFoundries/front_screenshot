...
$__System.registerDynamic('5', ['3', '6', '4'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var Renderer = $__require('3');
    var LinearGradientContainer = $__require('6');
    var log = $__require('4');
...
$__System.registerDynamic('c', ['9', 'b', 'd'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
...
$__System.registerDynamic('e', ['f', '9'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var XHR = $__require('f');
...
$__System.registerDynamic('6', ['11', '12'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var GradientContainer = $__require('11');
    var Color = $__require('12');
...
$__System.registerDynamic('14', ['4', '7', '8', 'a', 'c', 'e', '10', '6', '13', '9'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var log = $__require('4');
    var ImageContainer = $__require('7');
    var DummyImageContainer = $__require('8');
    var ProxyImageContainer = $__require('a');
    var FrameContainer = $__require('c');
    var SVGContainer = $__require('e');
    var SVGNodeContainer = $__require('10');
    var LinearGradientContainer = $__require('6');
    var WebkitGradientContainer = $__require('13');
...
$__System.registerDynamic("16", ["17"], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var NodeContainer = $__require("17");
...
$__System.registerDynamic('19', ['9'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var smallImage = $__require('9').smallImage;
...
$__System.registerDynamic('1c', ['4', '15', '17', '16', '18', '1a', '12', '1b', '9'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var log = $__require('4');
    var punycode = $__require('15');
    var NodeContainer = $__require('17');
    var TextContainer = $__require('16');
    var PseudoElementContainer = $__require('18');
    var FontMetrics = $__require('1a');
    var Color = $__require('12');
    var StackingContext = $__require('1b');
    var utils = $__require('9');
    var bind = utils.bind;
    var getBounds = utils.getBounds;
...
$__System.registerDynamic('17', ['12', '9'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var Color = $__require('12');
...
$__System.registerDynamic('b', ['f', '9', '4', '1d'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var XHR = $__require('f');
    var utils = $__require('9');
    var log = $__require('4');
    var createWindowClone = $__require('1d');
...
$__System.registerDynamic('d', ['2', '5', '14', '1c', '17', '4', '9', '1d', 'b'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var Support = $__require('2');
    var CanvasRenderer = $__require('5');
    var ImageLoader = $__require('14');
    var NodeParser = $__require('1c');
    var NodeContainer = $__require('17');
    var log = $__require('4');
    var utils = $__require('9');
    var createWindowClone = $__require('1d');
...
(function(global, factory) {
  'use strict';
  if (typeof define !== 'undefined' && define.amd) {
    define("20", ["1e", "1f"], factory) && define("canvgModule", ["20"], function(m) {
      return m;
    });
  } else if (typeof module !== 'undefined' && module.exports) {
...
$__System.register('1', ['20', 'd'], function (_export, _context) {
	"use strict";
...
//# sourceMappingURL=ig_screenshot.bundled.js.map