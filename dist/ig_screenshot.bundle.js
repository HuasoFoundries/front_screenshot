...
(function(global, factory) {
  'use strict';
  if (typeof define !== 'undefined' && define.amd) {
    define("5", ["3", "4"], factory) && define("canvgModule", ["5"], function(m) {
      return m;
    });
  } else if (typeof module !== 'undefined' && module.exports) {
...
$__System.registerDynamic('7', ['8', '9'], true, function ($__require, exports, module) {
    var define,
        ...
        GLOBAL = global;
    var log = $__require('8');
    var smallImage = $__require('9').smallImage;
...
$__System.registerDynamic("a", ["b"], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var ProxyURL = $__require("b").ProxyURL;
...
$__System.registerDynamic('e', ['d', 'f', '8'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var Renderer = $__require('d');
...
$__System.registerDynamic('2', ['c', 'e', '10', '11', '12', '8', '9', '13', 'b'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var Support = $__require('c');
    var CanvasRenderer = $__require('e');
    var ImageLoader = $__require('10');
    var NodeParser = $__require('11');
    var NodeContainer = $__require('12');
    var log = $__require('8');
    var utils = $__require('9');
    var createWindowClone = $__require('13');
    var loadUrlDocument = $__require('b').loadUrlDocument;
...
$__System.registerDynamic('14', ['9', 'b', '2'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var utils = $__require('9');
...
$__System.registerDynamic('15', ['16', '9'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var XHR = $__require('16');
    var decode64 = $__require('9').decode64;
...
$__System.registerDynamic('f', ['18', '19'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var GradientContainer = $__require('18');
    var Color = $__require('19');
...
$__System.registerDynamic('10', ['8', '6', '7', 'a', '14', '15', '17', 'f', '1a', '9'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var log = $__require('8');
    var ImageContainer = $__require('6');
    var DummyImageContainer = $__require('7');
    var ProxyImageContainer = $__require('a');
    var FrameContainer = $__require('14');
    var SVGContainer = $__require('15');
    var SVGNodeContainer = $__require('17');
    var LinearGradientContainer = $__require('f');
    var WebkitGradientContainer = $__require('1a');
    var bind = $__require('9').bind;
...
$__System.registerDynamic('1e', ['9'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var smallImage = $__require('9').smallImage;
...
$__System.registerDynamic('11', ['8', '1b', '12', '1c', '1d', '1f', '19', '20', '9'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var log = $__require('8');
    var punycode = $__require('1b');
    var NodeContainer = $__require('12');
    var TextContainer = $__require('1c');
    var PseudoElementContainer = $__require('1d');
    var FontMetrics = $__require('1f');
    var Color = $__require('19');
    var StackingContext = $__require('20');
    var utils = $__require('9');
    var bind = utils.bind;
    var getBounds = utils.getBounds;
...
$__System.registerDynamic('12', ['19', '9'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var Color = $__require('19');
...
$__System.registerDynamic("13", ["8"], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var log = $__require("8");
...
$__System.registerDynamic('b', ['16', '9', '8', '13'], true, function ($__require, exports, module) {
    var define,
        global = this || self,
        GLOBAL = global;
    var XHR = $__require('16');
...
$__System.register('1', ['5', '8', '9', '10', '11', '12', '13', 'c', 'e', 'b'], function (_export, _context) {
	"use strict";

	var Support, CanvasRenderer, ImageLoader, NodeParser, NodeContainer, log, utils, createWindowClone, proxy, canvg, loadUrlDocument, getBounds, html2canvasNodeAttribute, html2canvasCloneIndex, infoScreenShot, ig_screenshot;
	...
	return {
		setters: [function (_) {
			...
			ImageLoader = _4.default;
		}, function (_5) {
			NodeParser = _5.default;
		}, function (_6) {
			NodeContainer = _6.default;
		}, function (_7) {
			createWindowClone = _7.default;
		}, function (_c) {
			Support = _c.default;
		}, function (_e) {
			CanvasRenderer = _e.default;
		}, function (_b) {
			proxy = _b.default;
		}],
		execute: function () {
			loadUrlDocument = proxy.loadUrlDocument;
