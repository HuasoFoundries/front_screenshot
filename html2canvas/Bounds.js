...
export var Bounds = function () {
    function Bounds(x, y, w, h) {
        babelHelpers.classCallCheck(this, Bounds);
    ...
    babelHelpers.createClass(Bounds, null, [{
        key: 'fromClientRect',
...
export var parseBounds = function parseBounds(node) {
    return Bounds.fromClientRect(node.getBoundingClientRect());
};

export var calculatePaddingBox = function calculatePaddingBox(bounds, borders) {
    return new Bounds(bounds.left + borders[LEFT].borderWidth, bounds.top + borders[TOP].borderWidth, bounds.width - (borders[RIGHT].borderWidth + borders[LEFT].borderWidth), bounds.height - (borders[TOP].borderWidth + borders[BOTTOM].borderWidth));
};

export var calculateContentBox = function calculateContentBox(bounds, padding, borders) {
...
export var parseDocumentSize = function parseDocumentSize(document) {
...
export var parsePathForBorder = function parsePathForBorder(curves, borderSide) {
    switch (borderSide) {
        case TOP:
...
export var calculateBorderBoxPath = function calculateBorderBoxPath(curves) {
    return [curves.topLeftOuter, curves.topRightOuter, curves.bottomRightOuter, curves.bottomLeftOuter];
};

export var calculatePaddingBoxPath = function calculatePaddingBoxPath(curves) {
    return [curves.topLeftInner, curves.topRightInner, curves.bottomRightInner, curves.bottomLeftInner];
};

export var parseBoundCurves = function parseBoundCurves(bounds, borders, borderRadius) {
